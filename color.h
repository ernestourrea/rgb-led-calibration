...
// For color detection calibration
#define LThreshold 20.0
#define RedHThreshold 6600.0
#define GreenHThreshold 34600.0
#define BlueHThreshold 48800.0
...
*/
uint8_t Red, Green, Green2, Blue;
uint16_t RedData, GreenData, Green2Data, BlueData;
float RedRatio, GreenRatio, Green2Ratio, BlueRatio;
